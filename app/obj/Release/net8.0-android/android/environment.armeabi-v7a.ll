...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1889917342, ; hash 0x70a5d99e, from name: aot-VinhKhanhFoodTour
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2023021451, ; hash 0x7894db8b, from name: libaot-VinhKhanhFoodTour.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 2839958246, ; hash 0xa94652e6, from name: aot-VinhKhanhFoodTour.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 320
	...
	%struct.DSOCacheEntry {
		i64 3005510233, ; hash 0xb3247259, from name: VinhKhanhFoodTour.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 343
	...
	%struct.DSOCacheEntry {
		i64 3325274468, ; hash 0xc633a964, from name: VinhKhanhFoodTour
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 4166068249, ; hash 0xf8512819, from name: libaot-VinhKhanhFoodTour
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 469

...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670828, ; uint32_t jnienv_initialize_method_token (0x6001d6c)
	i32 100670827, ; uint32_t jnienv_registerjninatives_method_token (0x6001d6b)
...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1103452905124035276, ; hash 0xf504092244a7acc, from name: libaot-VinhKhanhFoodTour
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 26
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2682480067417598523, ; hash 0x253a1568af7dea3b, from name: aot-VinhKhanhFoodTour.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 69
	...
	%struct.DSOCacheEntry {
		i64 7741312715886007239, ; hash 0x6b6eaae65d9993c7, from name: VinhKhanhFoodTour
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 185
	...
	%struct.DSOCacheEntry {
		i64 13789451156179728666, ; hash 0xbf5df8c453b1391a, from name: aot-VinhKhanhFoodTour
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 356
	...
	%struct.DSOCacheEntry {
		i64 16195374527434191376, ; hash 0xe0c18753701ff210, from name: VinhKhanhFoodTour.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 420
	...
	%struct.DSOCacheEntry {
		i64 17433303437012496505, ; hash 0xf1ef891c40b9f079, from name: libaot-VinhKhanhFoodTour.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-VinhKhanhFoodTour.dll.so
		ptr null; void* handle (0x0)
	}, ; 449
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f1d80b18-5111-4882-9593-872d74691e11\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.vinhkhanh.foodtour\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-VinhKhanhFoodTour.dll.so\00", align 16
